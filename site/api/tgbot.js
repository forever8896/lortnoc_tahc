...
const cfg = {
  releaseUrl: process.env.X_EXT_RELEASE_URL || `${REPO}/releases/tag/x-v0.1.1`,
  ...
  downloadName: 'lortnoc-tahc-x-v0.1.1.zip',
  downloadUrl: process.env.X_EXT_DOWNLOAD_URL || `${REPO}/releases/download/x-v0.1.1/lortnoc-tahc-x-v0.1.1.zip`,
  repoUrl: REPO,
